        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 text-gray-700">We collect the following categories of information:</p>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 text-gray-700">We do not sell your personal information.</p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-grattia-accent">Sharing Your Information</h2>
              <p className="mb-4 text-gray-700">We may share your information only in the following circumstances:</p>
              <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700">
              ...
              <p className="mb-4 text-gray-700">We do not share your information with third parties for their own independent marketing purposes.</p>
            </section>
