...
const getStripeKey = async (supabaseAdmin: any, companyId: string): Promise<string> => {
  try {
    ...
    console.log(`[CHECK-SUBSCRIPTION-STATUS] Using company environment: ${environment}`);
    ...
    console.error(`[CHECK-SUBSCRIPTION-STATUS] Error getting Stripe key, defaulting to live:`, error);
